...
async def root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "get_expense_by_row": "/api/v1/expenses/row/{row_number}",
            "update_expense_by_row": "PUT /api/v1/expenses/row/{row_number}",
            "delete_expense_by_row": "DELETE /api/v1/expenses/row/{row_number}",
